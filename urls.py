...
urlpatterns = [
    ...
    path('application/<int:id>/dumpdata/', dump_data, name='dump-data'),
    ...
    path('application/<int:app_id>/model/<int:model_id>/field/add/', FieldCreateView.as_view(),
        name='field-create'),
    path('application/<int:app_id>/model/<int:model_id>/field/<pk>/', FieldDetailView.as_view(),
        name='field-details'),
    path('application/<int:app_id>/model/<int:model_id>/field/<pk>/update/', FieldUpdateView.as_view(),
        name='field-update'),
    # path('application/<app_id>/model/<model_id>/field/<pk>/update/', field_update, name='field-update'),
    path('application/<int:app_id>/model/<int:model_id>/field/<pk>/delete/', FieldDeleteView.as_view(),
        name='field-delete'),
