/**
 * Created by ozgur on 5/22/17.
 */

$(document).ready(function () {


    $("#add_model_menu_item").on("click", function () {

        var model_add_url = this.getAttribute('data-model-add-url');
        var csrftoken = $("[name*='csrfmiddlewaretoken']").val();

        $.get(model_add_url, function (data) {
            $(".add_model_modal_content").html(data);
    ...
    //Get field list
    $(".show_fieldListModal").click(function () {

        var fields_url = this.getAttribute('data-fields-url');
        var csrftoken = $("[name*='csrfmiddlewaretoken']").val();

        $.get(fields_url, function (data) {
            $(".model_field_ops_content").html(data);
